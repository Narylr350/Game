...
public class UtilTest {
    public static void main(String[] args) {
        ...
        GameAction action3 = new GameAction(1, ActionType.PASS, null);
        ...
        GameAction action4 = new GameAction(1, ActionType.PLAY_CARD, (List<Integer>) CardUtil.stringToCards("10jqkA", player1.getCards()));
        GameResult gameResult = gameFlow.handlePlayerAction(room, action4);
