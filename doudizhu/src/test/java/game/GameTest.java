...
public class GameTest {
    ...
    public void playerWhoPassedInCallStageCannotRobLater() {
        ...
        GameActionResult r2 = gameFlow.handlePlayerAction(room, player2, ActionType.PASS);

        // 3 号玩家：抢地主
        Integer player3 = room.getCurrentTurnPlayerId();
        GameActionResult r3 = gameFlow.handlePlayerAction(room, player3, ActionType.PASS);
